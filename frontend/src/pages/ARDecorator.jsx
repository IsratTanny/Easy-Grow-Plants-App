...
const resolveImg = (url) => {
    ...
    // On the web, normalise backend-absolute media URLs to a same-origin relative
    // path so the export canvas isn't tainted by CORS. On native there is no proxy,
    // so keep the absolute backend URL (the export uses crossOrigin + backend CORS).
    if (!isNative()) {
